...
@keyframes cur5 {
  ...
  8%       { transform: translate(calc(50% - 143px), 126px); }
  24%,42%  { transform: translate(calc(50% - 15px), 126px); }
  58%,76%  { transform: translate(calc(50% + 114px), 126px); }
  92%,94%  { transform: translate(calc(50% - 143px), 126px); }
